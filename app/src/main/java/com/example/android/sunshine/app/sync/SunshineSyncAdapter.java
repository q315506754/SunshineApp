    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                boolean push = prefs.getBoolean(getContext().getString(R.string.pref_enable_notifications_key),
                        Boolean.parseBoolean(getContext().getString(R.string.pref_enable_notifications_default)));
                Log.d(LOG_TAG, "pref_enable_notifications_key:"+push);
                if (push) {
                    notifyWeather();
                }
            }
...
//                Toast toast = Toast.makeText(context, contentText, Toast.LENGTH_LONG);
//                toast.show();
